...
for _, job in jobs_df.iterrows():
    ...
    if compatible.empty:
        print(f" No compatible machine found for Job {job['job_id']}")
        continue
...
print("✅ Schedule saved as 'final_schedule_ai.csv'")


# Plot Detailed Gantt Chart
...
plt.tight_layout()
plt.savefig("ai_schedule_detailed_plot.png")
plt.show()
